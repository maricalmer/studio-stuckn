    ...
    <>
      <PageContainer>
        ...
        <div className="ml-14 mt-32 helvetica text-[#4A2E69] relative h-[200vh]">
          ...
          <ul className="my-6">
            <li><Link href="mailto:info@mailgo.dev" className="text-3xl 2xl:text-5xl underline">Email</Link></li>
            <li className="my-2"><a href="https://www.instagram.com/studio.stuckn" target="_blank" className="text-3xl 2xl:text-5xl underline">Instagram</a></li>
            <li><a href="https://de.linkedin.com/in/ronja-stucken" target="_blank" className="text-3xl 2xl:text-5xl underline">LinkedIn</a></li>
          </ul>
          <div className="w-9/12 min-w-[600px] text-3xl 2xl:text-5xl my-6">Ronja Stucken, a Berlin-based 3D Artist, fashion designer and creative mind, showcases her works under the synonym Studio.Stuckn.</div>
          <div className="w-9/12 min-w-[600px] text-3xl 2xl:text-5xl mb-4">Services include comprehensive 3D design solutions for fashion, accessories, avatars, product visualization, animations, scene building, lighting and digital photoshoots, alongside expertise in physical fashion design and pattern making.</div>
