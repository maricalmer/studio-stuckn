...
const CarouselDescription = ({ title, subtitle, details, softwares, credits, previousProject, nextProject }) => {
  return (
    <div className="mb-8 md:w-[220px] h-fit md:h-[60vh] md:fixed left-[100px]">
      <div className="quella text-4xl mt-5 relative z-20 md:p-3">{title}</div>
      {subtitle && <div className={subtitle.cyrillic ? "helvetica text-sm mt-3 mb-3 relative z-20 leading-4 md:mt-0 md:px-3 font-bold" : "helvetica text-sm mb-3 mt-3 relative z-20 leading-4 md:mt-0 md:px-3"}>{subtitle.text}</div>}
      ...
      <div className="hidden md:flex w-full justify-center absolute bottom-2">
