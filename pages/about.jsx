    ...
    <>
        ...
        <PageContainer>
          ...
          <div className="ml-14 mt-24 helvetica text-[#4A2E69] relative h-[150vh]">
            ...
            <div className="w-7/12 min-w-[600px] text-2xl my-6">Ronja Stucken, a Berlin-based 3D Artist, fashion designer and creative mind, showcases her works under the synoym Studio.Stuckn.</div>
            <div className="w-7/12 min-w-[600px] text-2xl mb-4">Services include comprehensive 3D design solutions for fashion, accessories, avatars, product visualization, animations, scene building, lighting and digital photoshoots, alongside expertise in physical fashion design and pattern making.</div>
