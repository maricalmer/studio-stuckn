...
function Brand(props) {
  return (
    <h1 className="brand-text text-[80px] md:text-[100px] lg:text-[130px] xl:text-[160px] min-[2000px]:text-[235px] font-headline quella border-solid border-b-2 border-[#a1bf79] mt-[68vh] lg:mt-[66vh] xl:mt-[61vh] 2xl:mt-[64vh] min-[2000px]:mt-[62vh] mb-80 mx-14 leading-none w-10/12 sticky top-6 mix-blend-difference">
