...
function Carousel(props) {
  return (
    <div className="carousel h-[60vh] flex mt-20 gap-3 overflow-scroll overscroll-contain relative">
      ...
      <Link href="/etherea-part-one" className="project-container min-w-fit h-full relative transition-opacity ease-in-out">
        <Image
          src={lucyPic}
      ...
      <Link href="/etherea-part-two" className="project-container min-w-fit h-full relative transition-opacity ease-in-out">
        <Image
          src={marionPic}
          alt="3d avatar earings"
          className='project'
        ...
        />
        <div className="project-title opacity-0 absolute bottom-0 quella text-white pl-3 pb-3 text-4xl transition-opacity ease-in-out">Etherea Part II</div>
      </Link>
      ...
      <Link href="/etherea-part-three" className="project-container min-w-fit h-full relative transition-opacity ease-in-out">
        ...
        />
        <div className="project-title opacity-0 absolute bottom-0 quella text-white pl-3 pb-3 text-4xl transition-opacity ease-in-out">Alien Accessories</div>
      </Link>
      <div className="min-w-[275px] h-full "></div>
    </div>
  );
