...
import type {
  FashionCreditsViewModel,
  ImageViewModel,
} from "@/lib/content/types";
import type { CarouselDescriptionProps } from "@/components/CarouselDescription";
...
type CarouselElement =
  ...
  | { key: string; type: "image"; src: ImageViewModel; alt: string }
  | { key: string; type: "video"; src: string; title: string };
...
const handleClick = (
  ...
  direction == "left"
    ? (newScrollPosition = carousel.scrollLeft - 600)
    : (newScrollPosition = carousel.scrollLeft + 600);
...
export default function Carousel({
  ...
  description?: CarouselDescriptionProps;
  ...
  return (
    <div
      ...
      className="carousel md:h-[60vh] md:flex px-6 md:px-0 mt-36 gap-3 md:overflow-scroll md:overscroll-contain relative"
    >
      {description && (
        <CarouselDescription
          ...
          softwares={description.softwares}
          credits={description.credits}
          previousProject={description.previousProject}
          nextProject={description.nextProject}
        />
      )}
      ...
      {fashionCredits && (
        <CarouselFashionCredits fashionCredits={fashionCredits} />
      )}
